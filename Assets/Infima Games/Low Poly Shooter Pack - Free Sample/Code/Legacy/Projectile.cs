...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		// Si el proyectil colide con un enemigo
    if (collision.transform.CompareTag("Enemy"))
    {
        // Desactivar al enemigo (puedes usar .enabled para desactivar el script o .gameObject.SetActive(false) para desactivar todo el objeto)
        Enemy enemy = collision.gameObject.GetComponent<Enemy>();
        if (enemy != null)
        {
            // Desactivar el script del enemigo (si solo quieres desactivar su lógica)
            enemy.enabled = false;  // Desactiva el comportamiento del enemigo
